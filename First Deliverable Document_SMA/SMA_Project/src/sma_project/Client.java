...
public class Client {
    ...
    public String toString() {
        return "Client{" + "ClientId=" + ClientId + ", ClientLName=" + ClientLName + ", ClientFName=" + ClientFName + ", ClientPhone=" + ClientPhone + ", ClientEmail=" + ClientEmail + ", ClientAddress=" + ClientAddress + ", PackageId=" + PackageId + ", EmployeeId=" + EmployeeId + '}';
    }
