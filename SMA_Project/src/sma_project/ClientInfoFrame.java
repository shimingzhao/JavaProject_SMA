...
public class ClientInfoFrame extends javax.swing.JFrame {       
    ...
    public ClientInfoFrame(Client clientInfo) {
        initComponents();
        ClientInfoFrame_idTF.setText(String.format("%03d",clientInfo.getClientId()) );
                                        ...
                                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addGroup(jPanel1Layout.createSequentialGroup()
                                                ...
                                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                                    ...
                                                    .addComponent(ClientInfoFrame_empIdTF, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 159, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                            .addGroup(jPanel1Layout.createSequentialGroup()
                                                .addGap(21, 21, 21)
    ...
    private void ClientInfoFrame_EditBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ClientInfoFrame_EditBActionPerformed
        ...
        ClientModifyFrame clientModify = new ClientModifyFrame(client);
    ...
    private void ClientInfoFrame_DelBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ClientInfoFrame_DelBActionPerformed
        ...
        if (selectedOption == JOptionPane.YES_OPTION) {
            ProjectOracleConnection.ClientDeleteOracle(Integer.parseInt(ClientInfoFrame_idTF.getText()));
    ...
    public void updataFrame(Client c){
        ClientInfoFrame_idTF.setText(String.format("%03d", c.getClientId()));
        ClientInfoFrame_lnameTF.setText(c.getClientLName());
        ClientInfoFrame_fnameTF.setText(c.getClientFName());
        ClientInfoFrame_phoneTF.setText(c.getClientPhone());
        ClientInfoFrame_emailTF.setText(c.getClientEmail());
        ClientInfoFrame_addressTF.setText(c.getClientAddress());
        ClientInfoFrame_pIdTF.setText("" + c.getPackageId());
        ClientInfoFrame_empIdTF.setText("" + c.getEmployeeId());
    }
