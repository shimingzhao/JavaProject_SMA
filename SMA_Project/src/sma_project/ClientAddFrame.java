...
public class ClientAddFrame extends javax.swing.JFrame {
    ...
    public ClientAddFrame() {
        initComponents();
        Maxid = ProjectOracleConnection.MaxClientIDSearchOracle();
        String ClientId_str = String.format("%03d",Maxid + 1);
        ClientAddFrame_idTF.setText(ClientId_str);
    }
    ...
    private void initComponents() {
        ...
        ClientAddFrame_idTF.setEditable(false);
    ...
    private void ClientAddFrame_submitBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ClientAddFrame_submitBActionPerformed
        ...
        dispose();
//        MainJFrame.clientList.ClientListFrame_listJL.
