...
public class ShipCatAddFrame extends javax.swing.JFrame {
    ...
    public ShipCatAddFrame() {
        initComponents();
        Maxid = ProjectOracleConnection.MaxShipCatIDSearchOracle()+100;
        String Id_str = String.format("%03d",Maxid + 1);
        ShipCatAddFrame_IdTF.setText(Id_str);
    }
    ...
    private void initComponents() {
        ...
        ShipCatAddFrame_IdTF.setEditable(false);
    ...
    private void ShipCatAddFrame_SubmitBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ShipCatAddFrame_SubmitBActionPerformed
        ...
        String desc; 
        id = Maxid + 1;
        price = Double.parseDouble(ShipCatAddFrame_PriceTF.getText());
        desc = ShipCatAddFrame_DescTA.getText();
        ShipCategory ShipCat = new ShipCategory(id,price,desc);
        ProjectOracleConnection.ShipCatAddOracle(ShipCat);
        dispose();
