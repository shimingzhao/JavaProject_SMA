...
public class Client {
    ...
    public String toString() {
        return "ClientId: " + ClientId + ", Last Name: " + ClientLName + ", First Name: " + ClientFName + ", Phone Number: " + ClientPhone + ", Email: " + ClientEmail + ", Address: " + ClientAddress + ", PackageId: " + PackageId + ", EmployeeId: " + EmployeeId;
    }
