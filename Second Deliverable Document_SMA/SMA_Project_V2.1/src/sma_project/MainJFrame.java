...
public class MainJFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        CalShippingCCB.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Select shipping method", "Standard - 0", "Express - 5.00", "The Next Day - 10.00" }));
        ...
        CalPackageCCB.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Select package category", "Category 1 - 5.00", "Category 2 - 6.00", "Category 3 - 15.00" }));

        CalLocationCB.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Select location", "Canada Wide - 00.00", "USA - 12.00", "International - 30.00" }));
    ...
    private void EmpJMenu_ListItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EmpJMenu_ListItemActionPerformed
        ...
        EmpListFrame empList = new EmpListFrame(EmployeeArrayList);
    ...
    private void CalCalculateBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CalCalculateBActionPerformed
        ...
        switch(shipCatPriceIndex){
            case 1: shipCatPrice = 0.00;
                break;
            case 2: shipCatPrice = 5.00;
                break;
            case 3: shipCatPrice = 10.00;
                break;
        }
        switch(packCatPriceIndex){
            case 1: packCatPrice = 5.00;
                break;
            case 2: packCatPrice = 6.00;
                break;
            case 3: packCatPrice = 15.00;
                break;
        }
        switch(locationPriceIndex){
            case 1: locationPrice = 0.00;
                break;
            case 2: locationPrice = 12.00;
                break;
            case 3: locationPrice = 30.00;
                break;
        } 
